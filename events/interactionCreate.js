    ...
    if (interaction.customId == "open-ticket") {
      ...
      interaction.guild.channels.create(`ticket-${interaction.user.username}`, {
        ...
        const embed = new client.discord.MessageEmbed()
          .setColor('6d6ee8')
          .setAuthor({name: `${interaction.user.username}'s Ticket`, iconURL: 'https://cdn.discordapp.com/icons/967931206832369744/ade57511a36d487be54a0f3910e0aa9e.png?size=2048'})
          .setDescription('Selecione a categoria do seu Ticket')
          .setFooter({text: `${client.user.tag} || JN HOST`, iconURL: client.user.displayAvatarURL()})
          .setTimestamp();
            ...
            if (msg.deletable) {
              msg.delete().then(async () => {
                const embed = new client.discord.MessageEmbed()
                  ...
                  .setDescription(`<@!${interaction.user.id}> Criou um ticket com questões relacionadas \`${i.values[0]}\``)
                  .setFooter({text: `${client.user.tag} || JN HOST`, iconURL: client.user.displayAvatarURL()})
                  .setTimestamp();
        ...
        if (i.customId == 'confirm-close') {
          ...
          chan.edit({
            ...
            .then(async () => {
              const embed = new client.discord.MessageEmbed()
                .setColor('6d6ee8')
                .setAuthor({name: 'Ticket', iconURL: 'https://cdn.discordapp.com/icons/967931206832369744/ade57511a36d487be54a0f3910e0aa9e.png?size=2048'})
                .setDescription('```Obrigado Por Esta Aqui```')
                .setFooter({text: `${client.user.tag} || JN HOST`, iconURL: client.user.displayAvatarURL()})
                .setTimestamp();
    ...
    if (interaction.customId == "delete-ticket") {
      ...
      chan.messages.fetch().then(async (messages) => {
        ...
        var result = await paste.uploadContent(a, {uploadFormat: 'markdown'})
            const embed = new client.discord.MessageEmbed()
              .setAuthor({name: 'Ticket Logs', iconURL: 'https://cdn.discordapp.com/icons/967931206832369744/ade57511a36d487be54a0f3910e0aa9e.png?size=2048'})
